...
const Tranfooter = () => {
    ...
    return (
        <>
                            ...
                            <div className='row'>
                                ...
                                <div className="col-sm-6 col-md-4">
                                    <ul>
                                        ...
                                        <li style={{  color:"white" ,textDecoration: "none",fontFamily: "Poppins" }}> <i className="fa fa-phone-square" ></i> 0120 242 3303</li><br />
                                        <li style={{  color:"white" ,textDecoration: "none" ,fontFamily: "Poppins"}} > <i className="far fa-envelope"></i> oak.work4you@gmail.com</li><br />
                                        <li style={{  color:"white" , textDecoration: "none" ,fontFamily: "Poppins"}}><i className="fas fa-map-marker-alt" ></i> D-1 Sector-1,<br />Noida, Uttar Pradesh<br></br> 201301 </li><br />
                                    </ul>
           ...
           <center style={{marginTop:"0.6rem" ,fontFamily: "Poppins"}} className="left2">  © Copyright 2024, <Link to="/" style={{color:"yellow", textDecoration:"none"}}>oak.work4you@gmail.com </Link>  All Rights Reserved</center> 
           <center style={{marginTop:"0.6rem",fontFamily: "Poppins"}} className="right2">Designed By <Link to="/" style={{color:"yellow", textDecoration:"none"}}>OAK Developer</Link> </center> 
